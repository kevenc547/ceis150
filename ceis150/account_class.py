...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 20 14:09:50 2022

@author: keven
"""
from stock_class import Stock
#create retirement account with parameters balance and number 
class Retirement_Account:
    def __init__(self , balance , number ):
        self.balance = balance 
        self.number = number 
    
  #create traditionak with parameter balancer ,number and class retirment account   
...
#created robo  with parameters of class retirment account 
