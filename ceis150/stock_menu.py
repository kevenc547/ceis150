...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 12 14:05:57 2022
...
def add_stock(stock_list):
     option = " "
     while option != "0" :
         print ("adding a stocks")
         symbol = input("Enter a symbol : ").upper()
         name = input ("Enter company name : ")
         shares = float(input ("Enter number of shares : "))
         new_stock = Stock (symbol , name , shares)
         stock_list.append(new_stock)
         option = input("Please press enter to add another stock or press 0 to quit : ")
...
def delete_stock(stock_list):
     ...
     print("]")
     symbol = input("which stock you want to delete : ").upper()
     found = False  
     i = 0 
     for stock in stock_list:
